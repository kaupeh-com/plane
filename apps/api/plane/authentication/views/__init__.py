...
from .app.kauid import KauIDCallbackEndpoint, KauIDOauthInitiateEndpoint
...
from .space.kauid import KauIDCallbackSpaceEndpoint, KauIDOauthInitiateSpaceEndpoint
