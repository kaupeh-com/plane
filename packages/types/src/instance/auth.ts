...
export type TInstanceKauIDAuthenticationConfigurationKeys =
  | "KAUID_HOST"
  | "KAUID_CLIENT_ID"
  | "KAUID_CLIENT_SECRET";
...
export type TInstanceAuthenticationConfigurationKeys =
  ...
  | TInstanceKauIDAuthenticationConfigurationKeys;
...
export type TCoreLoginMediums = "email" | "magic-code" | "github" | "gitlab" | "google" | "gitea" | "kauid";
